...
using (var scope = app.Services.CreateScope())
{
    ...
    // walkthrough browses `GET /api/catalog` immediately after cluster
...
// route to it) and /api/catalog/version (Admin-gated, reached through the
...
app.MapGameEndpoints(GetVersion);
